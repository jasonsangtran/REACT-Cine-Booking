      ...
      <div className={classes.content}>
        <AppBar className={classes.appBar} position="static" >
          <Tabs centered value={value} onChange={handleChange}>
            <Tab disableRipple classes={{ root: classes.tabButton, selected: classes.tabSelected }} label="Điện Ảnh" />
            ...
            <div className="row">
              <div className={classes.repons}>
                <a href="#" className={classes.news}>
                  ...
                  <div className="py-3">
                    <h4 className="card-title">Ấn định chắc nịch ngày khởi chiếu 16.04, Lý Hải tung clip Lật Mặt: 48H</h4>
              ...
              <div className={classes.repons}>
                <a href="#" className={classes.news}>
                  ...
                  <div className="py-3">
                    <h4 className="card-title">CUỘC CHIẾN SINH TỬ - GỌI TÊN NHỮNG PHIM ĐIỆN ẢNH</h4>
                    <p className="text-secondary">Cư dân nơi khác đang sắp “gato nổ mắt” với dân Sài Thành khi sắp tới đâysẽ chào đón một rạp chiếu phim mang phong cách Artistic Urban Lifestyle đầu tiên tại Việt Nam</p>
                  </div>
                </a>
              </div>
            </div>
              ...
              <div className="col-sm-4 pl-0 pr-15">
                <a href="#" className={classes.news}>
                  ...
                  <div className="py-3">
                    ...
                    <p className="text-secondary">Quy tụ 3 nam tài tử vừa điển trai, vừa được đánh giá cao về năng lực diễn xuất là Park Seo Joon, Woo Do Hwan và Choi Woo Sik, tác phẩm kinh dị</p>
                  </div>
                </a>
              </div>
              <div className="col-sm-4 pl-0 pr-15" >
                <a className={classes.bonusNews} href="#">
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      <h6 className="text-secondary">Khai trương rạp xịn giá ngon tại Sài Gòn</h6>
                    </div>
                  </div>
                </a>
                <a className={classes.bonusNews} href="#">
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      <h6 className="text-secondary">“Bóc tem” tổ hợp giải trí mới toanh của Hà Thành</h6>
                    </div>
                  </div>
                </a>
                <a className={classes.bonusNews} href="#">
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      <h6 className="text-secondary">Tiệc Trăng Máu chính thức cán mốc 100 tỷ chỉ sau 2 tuần </h6>
                    </div>
                  </div>
                </a>
                <a className={classes.bonusNews} href="#">
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      <h6 className="text-secondary">NGÔ THANH VÂN CHÍNH THỨC KHỞI ĐỘNG CUỘC THI THIẾT KẾ</h6>
                    </div>
                  </div>
                </a>
              </div>
            ...
            <div className="row">
              ...
              <div className={classes.repons}>
                <a href="#" className={classes.news}>
                  ...
                  <div className="py-3">
                    <h4 className="card-title">Review: Dinh Thự Oan Khuất</h4>
              ...
              <div className="col-sm-4 pl-0 pr-15" >
                <a className={classes.bonusNews} href="#">
                  <div className="row mb-2">
                    ...
                    <div className="col-9">
                      <h6 className="text-secondary">Khai trương rạp xịn giá ngon, chuẩn Sài Gòn</h6>
                    </div>
                  </div>
                </a>
                <a className={classes.bonusNews} href="#">
